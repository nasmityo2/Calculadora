...
window.NexusRouter = (function () {
  const routes = [
    ...
    { id: 'cuentas_pagar', hash: 'cuentas_pagar', title: 'Cuentas por Pagar', html: 'pages/cuentas_pagar/cuentas_pagar.html' },
    ...
    { id: 'cotizaciones', hash: 'cotizaciones', title: 'Cotizaciones', html: 'pages/cotizaciones/cotizaciones.html' }
  ];
