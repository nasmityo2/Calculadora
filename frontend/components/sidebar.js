...
(function () {
  ...
  const ICONS = {
    ...
    cotizaciones:  svg('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2M12 12h.01M8 12h.01M16 12h.01M12 16h.01M8 16h.01')
  };
  ...
  function renderSidebar(container) {
    ...
    const GROUPS = [
      ...
      { label: 'Comercial',    ids: ['ventas', 'cotizaciones', 'clientes', 'cartera', 'cashea'] },
