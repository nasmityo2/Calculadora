...
function leerTasaBcvActual(_t) {
  const row = getOne(`SELECT valor FROM configuracion WHERE clave = 'tasa_bcv'`);
 ...
 */
function resolverMontoAbono(body, cuenta, _t) {
