...
router.get('/modo-red', requirePermission('config_read'), configuracionController.getModoRed);
router.patch('/modo-red', requirePermission('config_write'), configuracionController.patchModoRed);
